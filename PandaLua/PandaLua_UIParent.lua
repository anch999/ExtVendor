...
-- Per panel settings
PandaLua_UIPanelWindows = {};

--Center Menu Frames
PandaLua_UIPanelWindows["GameMenuFrame"] =				{ area = "center",		pushable = 0,	whileDead = 1 };
PandaLua_UIPanelWindows["VideoOptionsFrame"] =			{ area = "center",		pushable = 0,	whileDead = 1 };
PandaLua_UIPanelWindows["AudioOptionsFrame"] =			{ area = "center",		pushable = 0,	whileDead = 1 };
PandaLua_UIPanelWindows["InterfaceOptionsFrame"] =		{ area = "center",		pushable = 0,	whileDead = 1 };
PandaLua_UIPanelWindows["HelpFrame"] =					{ area = "center",		pushable = 0,	whileDead = 1 };

-- Frames using the new Templates
PandaLua_UIPanelWindows["CharacterFrame"] =				{ area = "left",			pushable = 3,	whileDead = 1};
PandaLua_UIPanelWindows["SpellBookFrame"] =				{ area = "left",			pushable = 1,	whileDead = 1, width = 575, height = 545 };
PandaLua_UIPanelWindows["TaxiFrame"] =					{ area = "left",			pushable = 0, 	width = 605, height = 580 };
PandaLua_UIPanelWindows["PVPUIFrame"] =					{ area = "left",			pushable = 0,	whileDead = 1, width = 563};
PandaLua_UIPanelWindows["PVPBannerFrame"] =				{ area = "left",			pushable = 1};
PandaLua_UIPanelWindows["PetStableFrame"] =				{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["PVEFrame"] =					{ area = "left",			pushable = 0, 	whileDead = 1, width = 563};
PandaLua_UIPanelWindows["EncounterJournal"] =			{ area = "left",			pushable = 0, 	whileDead = 1, width = 830};
PandaLua_UIPanelWindows["PetJournalParent"] =			{ area = "left",			pushable = 0, 	whileDead = 1, width = 830};
PandaLua_UIPanelWindows["TradeFrame"] =					{ area = "left",			pushable = 1};
PandaLua_UIPanelWindows["LootFrame"] =					{ area = "left",			pushable = 7};
PandaLua_UIPanelWindows["PandaLua_MerchantFrame"] =				{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["TabardFrame"] =					{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["PVPBannerFrame"] =				{ area = "left",			pushable = 1};
PandaLua_UIPanelWindows["MailFrame"] =					{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["BankFrame"] =					{ area = "left",			pushable = 6,	width = 425 };
PandaLua_UIPanelWindows["QuestLogFrame"] =				{ area = "doublewide",		pushable = 0,	whileDead = 1 };
PandaLua_UIPanelWindows["QuestLogDetailFrame"] =			{ area = "left",			pushable = 1,	whileDead = 1 };
PandaLua_UIPanelWindows["QuestFrame"] =					{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["GuildRegistrarFrame"] =			{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["GossipFrame"] =					{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["DressUpFrame"] =				{ area = "left",			pushable = 2};
PandaLua_UIPanelWindows["PetitionFrame"] =				{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["ItemTextFrame"] =				{ area = "left",			pushable = 0};
PandaLua_UIPanelWindows["FriendsFrame"] =				{ area = "left",			pushable = 0,	whileDead = 1, extraWidth = 32};
PandaLua_UIPanelWindows["RaidParentFrame"] =				{ area = "left",			pushable = 1,	whileDead = 1 };
PandaLua_UIPanelWindows["RaidBrowserFrame"] =			{ area = "left",			pushable = 1,	};


-- Frames NOT using the new Templates
PandaLua_UIPanelWindows["WorldMapFrame"] =				{ area = "full",			pushable = 0, 		xoffset = -16, 		yoffset = 12,	whileDead = 1 };
PandaLua_UIPanelWindows["CinematicFrame"] =				{ area = "full",			pushable = 0, 		xoffset = -16, 		yoffset = 12,	whileDead = 1 };
PandaLua_UIPanelWindows["ChatConfigFrame"] =				{ area = "center",			pushable = 0, 		xoffset = -16, 		yoffset = 12,	whileDead = 1 };
PandaLua_UIPanelWindows["WorldStateScoreFrame"] =		{ area = "center",			pushable = 0, 		xoffset = -16, 		yoffset = 12,	whileDead = 1 };
PandaLua_UIPanelWindows["QuestChoiceFrame"] =			{ area = "center",			pushable = 0, 		xoffset = -16, 		yoffset = 12,	whileDead = 0, allowOtherPanels = 1 };

local function GetPandaLua_UIPanelWindowInfo(frame, name)
	if ( not frame:GetAttribute("PandaLua_UIPanelLayout-defined") ) then
	    local info = PandaLua_UIPanelWindows[frame:GetName()];
	    if ( not info ) then
			return;
	    end
		frame:SetAttribute("PandaLua_UIPanelLayout-defined", true);
	    for name,value in pairs(info) do
			frame:SetAttribute("PandaLua_UIPanelLayout-"..name, value);
		end
	end
	return frame:GetAttribute("PandaLua_UIPanelLayout-"..name);
end

function SetPandaLua_UIPanelAttribute(frame, name, value)
	local info = PandaLua_UIPanelWindows[frame:GetName()];
	if ( not info ) then
		return;
	end
...
function ToggleHelpFrame()
	if ( HelpFrame:IsShown() ) then
		HidePandaLua_UIPanel(HelpFrame);
	else
...
function ToggleRaidBrowser()
	...
	if ( RaidBrowserFrame:IsShown() ) then
		HidePandaLua_UIPanel(RaidBrowserFrame);
	else
		ShowPandaLua_UIPanel(RaidBrowserFrame);
	end
	...
	if ( PetJournalParent ) then
		if ( whichFrame ) then
			...
			if ( PetJournalParent:IsShown() and whichFrame == PanelTemplates_GetSelectedTab(PetJournalParent) ) then
				HidePandaLua_UIPanel(PetJournalParent);
			else
				ShowPandaLua_UIPanel(PetJournalParent);
...
function UIParent_OnEvent(self, event, ...)
	...
	elseif ( event == "CONFIRM_XP_LOSS" ) then
		...
		HidePandaLua_UIPanel(GossipFrame);
...
--			end
	...
	elseif ( event == "GUILDBANKFRAME_OPENED" ) then
		...
		if ( GuildBankFrame ) then
			ShowPandaLua_UIPanel(GuildBankFrame);
	...
	elseif ( event == "GUILDBANKFRAME_CLOSED" ) then
		if ( GuildBankFrame ) then
			HidePandaLua_UIPanel(GuildBankFrame);
		end
	...
	elseif ( event == "BARBER_SHOP_CLOSE" ) then
		BarberShopFrame_LoadUI();
		if ( BarberShopFrame ) then
			HidePandaLua_UIPanel(BarberShopFrame);
		end
...
local function FramePositionDelegate_OnAttributeChanged(self, attribute)
	if ( attribute == "panel-show" ) then
		...
		self:ShowPandaLua_UIPanel(frame, force);
	elseif ( attribute == "panel-hide" ) then
		local frame = self:GetAttribute("panel-frame");
		local skipSetPoint = self:GetAttribute("panel-skipSetPoint");
		self:HidePandaLua_UIPanel(frame, skipSetPoint);
	elseif ( attribute == "panel-update" ) then
		local frame = self:GetAttribute("panel-frame");
		self:UpdatePandaLua_UIPanelPositions(frame);
...
function FramePositionDelegate:ShowPandaLua_UIPanel(frame, force)
	local frameArea, framePushable;
	frameArea = GetPandaLua_UIPanelWindowInfo(frame, "area");
	if ( not CanOpenPanels() and frameArea ~= "center" and frameArea ~= "full" ) then
		self:ShowPandaLua_UIPanelFailed(frame);
		return;
	end
	framePushable = GetPandaLua_UIPanelWindowInfo(frame, "pushable") or 0;

	if ( UnitIsDead("player") and not GetPandaLua_UIPanelWindowInfo(frame, "whileDead") ) then
		NotWhileDeadError();
		return;
	end
	...
	if ( self:GetPandaLua_UIPanel("fullscreen") and (frameArea ~= "full") ) then
		if ( force ) then
			self:SetPandaLua_UIPanel("fullscreen", nil, 1);
		else
			self:ShowPandaLua_UIPanelFailed(frame);
			return;
		end
	...
	local centerFrame = self:GetPandaLua_UIPanel("center");
	local centerArea, centerPushable;
	if ( centerFrame ) then
		if ( GetPandaLua_UIPanelWindowInfo(centerFrame, "allowOtherPanels") ) then
			HidePandaLua_UIPanel(centerFrame);
			centerFrame = nil;
		else	
			centerArea = GetPandaLua_UIPanelWindowInfo(centerFrame, "area");
			if ( centerArea and (centerArea == "center") and (frameArea ~= "center") and (frameArea ~= "full") ) then
				if ( force ) then
					self:SetPandaLua_UIPanel("center", nil, 1);
				else
					self:ShowPandaLua_UIPanelFailed(frame);
					return;
				end
			end
			centerPushable = GetPandaLua_UIPanelWindowInfo(centerFrame, "pushable") or 0;
		end
	end
	...
	if ( frameArea == "full" ) then
		securecall("CloseAllWindows");
		self:SetPandaLua_UIPanel("fullscreen", frame);
		return;
	end
	...
	if ( frameArea == "center" ) then
		...
		if ( not GetPandaLua_UIPanelWindowInfo(frame, "allowOtherPanels") ) then
			securecall("CloseAllBags");
		end
		self:SetPandaLua_UIPanel("center", frame, 1);
		return;
	end

	-- Doublewide frames take up the left and center spots
	if ( frameArea == "doublewide" ) then
		local leftFrame = self:GetPandaLua_UIPanel("left");
		if ( leftFrame ) then
			local leftPushable = GetPandaLua_UIPanelWindowInfo(leftFrame, "pushable") or 0;
			if ( leftPushable > 0 and CanShowRightPandaLua_UIPanel(leftFrame) ) then
				-- Push left to right
				self:MovePandaLua_UIPanel("left", "right", 1);
			elseif ( centerFrame and CanShowRightPandaLua_UIPanel(centerFrame) ) then
				self:MovePandaLua_UIPanel("center", "right", 1);
			end
		end
		self:SetPandaLua_UIPanel("doublewide", frame);
		return;
	end
	
	-- If not pushable, close any doublewide frames
	local doublewideFrame = self:GetPandaLua_UIPanel("doublewide");
	if ( doublewideFrame ) then
		if ( framePushable == 0 ) then
			-- Set as left (closes doublewide) and slide over the right frame
			self:SetPandaLua_UIPanel("left", frame, 1);
			self:MovePandaLua_UIPanel("right", "center");
		elseif ( CanShowRightPandaLua_UIPanel(frame) ) then
			-- Set as right
			self:SetPandaLua_UIPanel("right", frame);
		else
			self:SetPandaLua_UIPanel("left", frame);
		end
		return;
	end
	...
	if ( centerFrame and not rightFrame ) then
		...
		elseif ( framePushable < leftPushable ) then
			if ( centerArea == "center" ) then
				...
				if ( CanShowPandaLua_UIPanels(frame, leftFrame, centerFrame) ) then
					-- Shift both
					self:MovePandaLua_UIPanel("center", "right", 1);
					self:MovePandaLua_UIPanel("left", "center", 1);
					self:SetPandaLua_UIPanel("left", frame);
				else
					-- Replace left
					self:SetPandaLua_UIPanel("left", frame);
		...
		elseif ( framePushable <= centerPushable and centerArea ~= "center" and CanShowPandaLua_UIPanels(leftFrame, frame, centerFrame) ) then
			-- Push center
			self:MovePandaLua_UIPanel("center", "right", 1);
			self:SetPandaLua_UIPanel("center", frame);
	...
	-- Three are shown
	local rightPushable = GetPandaLua_UIPanelWindowInfo(rightFrame, "pushable") or 0;
	if ( framePushable > rightPushable ) then
		-- This one is highest priority, slide the other two over
		if ( CanShowPandaLua_UIPanels(centerFrame, rightFrame, frame) ) then
			self:MovePandaLua_UIPanel("center", "left", 1);
			self:MovePandaLua_UIPanel("right", "center", 1);
			self:SetPandaLua_UIPanel("right", frame);
		else
			self:MovePandaLua_UIPanel("right", "left", 1);
			self:SetPandaLua_UIPanel("center", frame);
		end
...
function FramePositionDelegate:ShowPandaLua_UIPanelFailed(frame)
	local showFailedFunc = _G[GetPandaLua_UIPanelWindowInfo(frame, "showFailedFunc")];
	if ( showFailedFunc ) then
		showFailedFunc(frame);
	end
end

function FramePositionDelegate:SetPandaLua_UIPanel(key, frame, skipSetPoint)
	...
	if ( not skipSetPoint ) then
		securecall("UpdatePandaLua_UIPanelPositions", frame);
	end
...
function FramePositionDelegate:MovePandaLua_UIPanel(current, new, skipSetPoint)
	if ( current ~= "left" and current ~= "center" and current ~= "right" and new ~= "left" and new ~= "center" and new ~= "right" ) then
		return;
	end

	self:SetPandaLua_UIPanel(new, nil, skipSetPoint);
	if ( self[current] ) then
		self[current]:Raise();
		self[new] = self[current];
		self[current] = nil;
		if ( not skipSetPoint ) then
			securecall("UpdatePandaLua_UIPanelPositions");
		end
	end
end

function FramePositionDelegate:HidePandaLua_UIPanel(frame, skipSetPoint)
	-- If we're hiding the full-screen frame, just hide it
	if ( frame == self:GetPandaLua_UIPanel("fullscreen") ) then
		self:SetPandaLua_UIPanel("fullscreen", nil);
		return;
	end
	
	-- If we're hiding the right frame, just hide it
	if ( frame == self:GetPandaLua_UIPanel("right") ) then
		self:SetPandaLua_UIPanel("right", nil, skipSetPoint);
		return;
	elseif ( frame == self:GetPandaLua_UIPanel("doublewide") ) then
		-- Slide over any right frame (hides the doublewide)
		self:MovePandaLua_UIPanel("right", "left", skipSetPoint);
		return;
	end
	...
	if ( frame == centerFrame ) then
		self:MovePandaLua_UIPanel("right", "center", skipSetPoint);
	elseif ( frame == self:GetPandaLua_UIPanel("left") ) then
		-- If we're hiding the left frame, move the other frames left, unless the center is a native center frame
		if ( centerFrame ) then
			local area = GetPandaLua_UIPanelWindowInfo(centerFrame, "area");
			if ( area ) then
				if ( area == "center" ) then
		...
		self:SetPandaLua_UIPanel("left", nil, skipSetPoint);
	else
		frame:Hide();
	end
end

function FramePositionDelegate:GetPandaLua_UIPanel(key)
...
function FramePositionDelegate:UpdatePandaLua_UIPanelPositions(currentFrame)
	...
	local info;
	local frame = self:GetPandaLua_UIPanel("left");
	if ( frame ) then
		local xOff = GetPandaLua_UIPanelWindowInfo(frame,"xoffset") or 0;
		local yOff = GetPandaLua_UIPanelWindowInfo(frame,"yoffset") or 0;
		local yPos = ClampPandaLua_UIPanelY(frame, yOff + topOffset);
		frame:ClearAllPoints();
		frame:SetPoint("TOPLEFT", "UIParent", "TOPLEFT", leftOffset + xOff, yPos);
		centerOffset = leftOffset + GetPandaLua_UIPanelWidth(frame) + xOff;
		UIParent:SetAttribute("CENTER_OFFSET", centerOffset);
		frame:Raise();
	else
		frame = self:GetPandaLua_UIPanel("doublewide");
		if ( frame ) then
			local xOff = GetPandaLua_UIPanelWindowInfo(frame,"xoffset") or 0;
			local yOff = GetPandaLua_UIPanelWindowInfo(frame,"yoffset") or 0;
			local yPos = ClampPandaLua_UIPanelY(frame, yOff + topOffset);
			frame:ClearAllPoints();
			frame:SetPoint("TOPLEFT", "UIParent", "TOPLEFT", leftOffset + xOff, yPos);
			rightOffset = leftOffset + GetPandaLua_UIPanelWidth(frame) + xOff;
			UIParent:SetAttribute("RIGHT_OFFSET", rightOffset);
			frame:Raise();
		end
	end

	frame = self:GetPandaLua_UIPanel("center");
	if ( frame ) then
		if ( CanShowCenterPandaLua_UIPanel(frame) ) then
			local area = GetPandaLua_UIPanelWindowInfo(frame, "area");
			local xOff = GetPandaLua_UIPanelWindowInfo(frame,"xoffset") or 0;
			local yOff = GetPandaLua_UIPanelWindowInfo(frame,"yoffset") or 0;
			local yPos = ClampPandaLua_UIPanelY(frame, yOff + topOffset);
			if ( area ~= "center" ) then
			...
			rightOffset = centerOffset + GetPandaLua_UIPanelWidth(frame) + xOff;
		else
			if ( frame == currentFrame ) then
				frame = self:GetPandaLua_UIPanel("left") or self:GetPandaLua_UIPanel("doublewide");
				if ( frame ) then
					self:HidePandaLua_UIPanel(frame);
					self.updatingPanels = nil;
					self:UpdatePandaLua_UIPanelPositions(currentFrame);
					return;
				end
			end
			self:SetPandaLua_UIPanel("center", nil, 1);
		...
		frame:Raise();
	elseif ( not self:GetPandaLua_UIPanel("doublewide") ) then
		if ( self:GetPandaLua_UIPanel("left") ) then
			rightOffset = centerOffset + UIParent:GetAttribute("DEFAULT_FRAME_WIDTH");
		else
	...
	frame = self:GetPandaLua_UIPanel("right");
	if ( frame ) then
		if ( CanShowRightPandaLua_UIPanel(frame) ) then
			local xOff = GetPandaLua_UIPanelWindowInfo(frame,"xoffset") or 0;
			local yOff = GetPandaLua_UIPanelWindowInfo(frame,"yoffset") or 0;
			local yPos = ClampPandaLua_UIPanelY(frame, yOff + topOffset);
			xOff = xOff + xSpacing; -- add sperating space
			...
			if ( frame == currentFrame ) then
				frame = GetPandaLua_UIPanel("center") or GetPandaLua_UIPanel("left") or GetPandaLua_UIPanel("doublewide");
				if ( frame ) then
					self:HidePandaLua_UIPanel(frame);
					self.updatingPanels = nil;
					self:UpdatePandaLua_UIPanelPositions(currentFrame);
			...
			self:SetPandaLua_UIPanel("right", nil, 1);
		end
		frame:Raise();
	end
...
function ToggleFrame(frame)
	if ( frame:IsShown() ) then
		HidePandaLua_UIPanel(frame);
	else
		ShowPandaLua_UIPanel(frame);
	end
end

function ShowPandaLua_UIPanel(frame, force)	
	if ( not frame or frame:IsShown() ) then
		return;
	end
	if ( not GetPandaLua_UIPanelWindowInfo(frame, "area") ) then
		frame:Show();
		return;
	end
...
function HidePandaLua_UIPanel(frame, skipSetPoint)
...
function HideParentPanel(self)	
	HidePandaLua_UIPanel(self:GetParent());
end

function GetPandaLua_UIPanel(key)
	return FramePositionDelegate:GetPandaLua_UIPanel(key);
end

function GetPandaLua_UIPanelWidth(frame)
	return GetPandaLua_UIPanelWindowInfo(frame, "width") or frame:GetWidth() + (GetPandaLua_UIPanelWindowInfo(frame, "extraWidth") or 0);
end

function GetPandaLua_UIPanelHeight(frame)
	return GetPandaLua_UIPanelWindowInfo(frame, "height") or frame:GetHeight() + (GetPandaLua_UIPanelWindowInfo(frame, "extraHeight") or 0);
end

--Allow a bit of overlap because there are built-in transparencies and buffers already
local MINIMAP_OVERLAP_ALLOWED = 60;

function GetMaxPandaLua_UIPanelsWidth()
...
function ClampPandaLua_UIPanelY(frame, yOffset)
	local bottomPos = UIParent:GetTop() + yOffset - GetPandaLua_UIPanelHeight(frame);
...
function CanShowRightPandaLua_UIPanel(frame)
	local width;
	if ( frame ) then
		width = GetPandaLua_UIPanelWidth(frame);
	else
		width = UIParent:GetAttribute("DEFAULT_FRAME_WIDTH");
	end
	
	local rightSide = UIParent:GetAttribute("RIGHT_OFFSET") + width;
	if ( rightSide < GetMaxPandaLua_UIPanelsWidth() ) then
		return 1;
	end
end

function CanShowCenterPandaLua_UIPanel(frame)
	local width;
	if ( frame ) then
		width = GetPandaLua_UIPanelWidth(frame);
	else
...
function CanShowPandaLua_UIPanels(leftFrame, centerFrame, rightFrame)
	local offset = UIParent:GetAttribute("LEFT_OFFSET");

	if ( leftFrame ) then
		offset = offset + GetPandaLua_UIPanelWidth(leftFrame);
		if ( centerFrame ) then
			local area = GetPandaLua_UIPanelWindowInfo(centerFrame, "area");
			if ( area ~= "center" ) then
				offset = offset + ( GetPandaLua_UIPanelWindowInfo(centerFrame, "width") or UIParent:GetAttribute("DEFAULT_FRAME_WIDTH") );
			else
				offset = offset + GetPandaLua_UIPanelWidth(centerFrame);
			end
			if ( rightFrame ) then
				offset = offset + GetPandaLua_UIPanelWidth(rightFrame);
			end
		end
	elseif ( centerFrame ) then
		offset = GetPandaLua_UIPanelWidth(centerFrame);
	end
	
	if ( offset < GetMaxPandaLua_UIPanelsWidth() ) then
		return 1;
	end
end
...
function CanOpenPanels()
	...
	local centerFrame = GetPandaLua_UIPanel("center");
	if ( not centerFrame ) then
		return 1;
	end

	local area = GetPandaLua_UIPanelWindowInfo(centerFrame, "area");
	local allowOtherPanels = GetPandaLua_UIPanelWindowInfo(centerFrame, "allowOtherPanels");
...
function CloseWindows(ignoreCenter, frameToIgnore)
	...
	local leftFrame = GetPandaLua_UIPanel("left");
	local centerFrame = GetPandaLua_UIPanel("center");
	local rightFrame = GetPandaLua_UIPanel("right");
	local doublewideFrame = GetPandaLua_UIPanel("doublewide");
	local fullScreenFrame = GetPandaLua_UIPanel("fullscreen");
	...
	if ( not frameToIgnore or frameToIgnore ~= leftFrame ) then
		HidePandaLua_UIPanel(leftFrame, 1);
	end
	
	HidePandaLua_UIPanel(fullScreenFrame, 1);
	HidePandaLua_UIPanel(doublewideFrame, 1);
	
	if ( not frameToIgnore or frameToIgnore ~= centerFrame ) then
		if ( centerFrame ) then
			local area = GetPandaLua_UIPanelWindowInfo(centerFrame, "area");
			if ( area ~= "center" or not ignoreCenter ) then
				HidePandaLua_UIPanel(centerFrame, 1);
			end	
		end
	end
	...
	if ( not frameToIgnore or frameToIgnore ~= rightFrame ) then
		if ( rightFrame ) then
			HidePandaLua_UIPanel(rightFrame, 1);
		end
	end

	found = securecall("CloseSpecialWindows") or found;
	
	UpdatePandaLua_UIPanelPositions();
...
function CloseAllWindows_WithExceptions()
	...
	if ( GetPandaLua_UIPanel("center") == WorldStateScoreFrame ) then
		CloseAllWindows(1);
...
function UpdatePandaLua_UIPanelPositions(currentFrame)
...
function ToggleGameMenu()
	...
	elseif ( GameMenuFrame:IsShown() ) then
		...
		HidePandaLua_UIPanel(GameMenuFrame);
	...
	elseif ( OpacityFrame:IsShown() ) then
		...
		ShowPandaLua_UIPanel(GameMenuFrame);
	end
end
