...
function PandaLua_SearchBoxTemplate_OnLoad(self)
	self:SetText(SEARCH);
...
function PandaLua_SearchBoxTemplate_OnEditFocusLost(self)
...
ITEM_SEARCHBAR_LIST = {
	"BagItemPandaLua_SearchBox",
	"GuildItemPandaLua_SearchBox",
	"VoidItemPandaLua_SearchBox",
	"BankItemPandaLua_SearchBox",
};
